  ...
  return (
    <footer className="bg-brand-black text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <Link href="/" className="inline-block mb-4">
              <Image src="/logo.png" alt="LukMaTic Logo" width={120} height={112} className="h-14 w-auto" />
            </Link>
            ...
            <div className="flex items-center gap-3 mt-4 bg-white/5 rounded-lg p-3 w-fit">
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="flex items-start gap-3 text-gray-400 text-sm hover:text-brand-orange transition-colors group"
                >
              ...
              <li>
                <a
                  ...
                  className="flex items-start gap-3 text-gray-400 text-sm hover:text-brand-orange transition-colors"
                >
              ...
              <li className="flex items-start gap-3 text-gray-400 text-sm">
                ...
                <div className="font-body">
                  ...
                  <div className="text-brand-orange font-semibold mt-1">
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 py-5 flex flex-col sm:flex-row items-center justify-between gap-2 text-sm text-gray-500 font-body">
